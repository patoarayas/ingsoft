        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <a href ="{{route('home')}}"class="btn btn-primary float-left">Volver</a>
                        ACTIVIDAD DE TITULACIÓN PARA INSCRIPCIÓN FORMAL
                </div>
                    ...
                    <table class = "table table-striped table-hover" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td with="10px">
                                    <a href="{{route('works2.show',$work->id)}}" class = "btn btn-primary ">Mostrar</a>
                                </td>

                                <td with="10px"> <!-- el edit en controlador works2 , realiza lo de agregar codigo de curricular-->
                                    <a href="{{route('works2.edit',$work->id)}}" class = "btn btn-success">Añadir Código</a>
                                </td>
